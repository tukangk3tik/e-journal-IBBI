...
class Profil extends CI_Controller {
	...
	public function index(){
		$data["profil"] = $this->user_model->getUser($this->session->userdata("userid"));
	...
	public function simpan(){
		if($this->input->post()){
			if($this->_validate()){
				...
				$this->user_model->updateUser($this->input->post("userid"),$data);
				...
				if($this->upload->do_upload("gambar")){
					$this->session->set_flashdata("error-message","Berhasil UPDATE data user");
				} else {
