        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <?php 
                    ...
                    if ($message){
                        echo "<div class='alert alert-success alert-dismissible'><button type='button' class='close' data-dismiss='alert'>
                ...
                <form action="profil/simpan" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group <?= form_error("alamat")?"has-error":"" ?>">
                        ...
                        <textarea id="alamat" name="alamat" rows="5"
                            class="form-control"><?= isset($profil)?$profil->alamat:set_value("alamat") ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="gambar" id="gambar" accept="image/x-png" class="form-control">
                    </div>
